...
urlpatterns = [
    ...
    path('profile/connections/google/disconnect/', views.disconnect_google, name='disconnect_google'),
    ...
    path('profile/sessions/terminate-others/', views.terminate_other_sessions, name='terminate_other_sessions'),
